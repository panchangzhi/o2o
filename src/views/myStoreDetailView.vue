        ...
        <list class="my-store">
            <cell class="cell">
                ...
                <div v-if="store.faildescription" class="reason">
                    <image style="width: 28px;height: 28px;" src="https://s.kcimg.cn/wap/images/detail/o2oImg/settled_error@2x.png"></image>
                ...
                <div class="contact linkCall">
                    ...
                    <image style="width: 36px;height: 36px;" src="https://s.kcimg.cn/wap/images/detail/o2oImg/settled_number@2x.png"></image>
                    <a href="tel:010-57015663">
                        <text class="service-text">联系客服修改</text>
                    </a>
                </div>

                <!-- 编辑 提交按钮-->
                <div class="button" @click="goEdit">
...
<script type="text/babel">
    ...
    export default{
        ...
        created(){
            this.url = Tools.hostFetch();//Tools.hostFetch();//判断请求那个接口

            //this.url = 'http://nearbyserviceapi/shopout/shopinfo.aspx?bbsid=25262';
